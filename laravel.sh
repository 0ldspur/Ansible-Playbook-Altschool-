...
# CLONEING OF LARAVEL APPLICATION AND ALL DEPENDENCIES
...
# CONFIGURING MYSQL: USER AND PASSWORD
...
sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=Oldspur/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=Oldspur@23/' /var/www/html/laravel/.env
